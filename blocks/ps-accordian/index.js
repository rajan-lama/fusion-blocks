    ...
    class AdvAccordion extends Component {
        ...
        render() {
            ...
            return (
                <Fragment>
                    <InspectorControls>
                        <PanelBody title={ __( 'Notice', 'prosys-power-block' ) }>
                        ...
                        <PanelBody title={ __( 'Accordion Settings', 'prosys-power-block' ) }>
                            <RangeControl
                        ...
                        <PanelBody title={ __( 'Header Settings', 'prosys-power-block' ) }>
                            <BaseControl label={ __( 'Header Icon Style', 'prosys-power-block' ) }>
                        ...
                        />
                        <PanelBody title={ __( 'Border Settings', 'prosys-power-block' ) } initialOpen={ false }>
                            <SelectControl
                                label={ __( 'Border Style', 'prosys-power-block' ) }
                                value={ borderStyle }
                                options={ [
                                    { label: __( 'Solid', 'prosys-power-block' ), value: 'solid' },
                                    { label: __( 'Dashed', 'prosys-power-block' ), value: 'dashed' },
                                    { label: __( 'Dotted', 'prosys-power-block' ), value: 'dotted' },
                                ] }
                        ...
                        <PanelBody title={ __( 'Accordions State', 'prosys-power-block' ) } initialOpen={  false }>
                            <ToggleControl
